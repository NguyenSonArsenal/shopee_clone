...
export const LABEL_CLOSE_MODAL = 'Đóng'
export const LABEL_CONFIRM_DELETE_MODAL = 'Xóa'
export const TOOLTIP_ICON_VIEW = 'Xem'
export const TOOLTIP_ICON_EDIT = 'Sửa'
export const TOOLTIP_ICON_DELETE = 'Xóa'
